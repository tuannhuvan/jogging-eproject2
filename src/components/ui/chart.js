  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        data-chart={idToUse}
        className={cn(
          "flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-none [&_.recharts-polar-grid-concentric-polygon]:stroke-border [&_.recharts-polar-grid-header-line]:stroke-border [&_.recharts-polar-grid-concentric-circle]:stroke-border [&_.recharts-surface]:outline-none [&_.recharts-tooltip-cursor]:fill-border/20 [&_.recharts-yAxis.recharts-cartesian-axis]:-translate-x-1 [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-none [&_.recharts-surface]:overflow-visible",
          className
        )}
        {...props}
      >
